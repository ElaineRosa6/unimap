...
- [2026-07-17 代码逻辑、API 适配与用户体验问题报告](CODE_LOGIC_API_UX_REVIEW_2026-07-17.md)：当前工作区的配置、CLI/GUI API、调度、分布式任务、会话和 Web 交互问题清单与建议修复顺序。
- [2026-07-17 完整修复与回滚指南](REMEDIATION_GUIDE_2026-07-17.md)：上述 14 项的实施结果、兼容性说明、验证门槛和上线回滚清单。
- [2026-07-17 逻辑、API 与体验问题修复指南](REMEDIATION_GUIDE_2026-07-17.md)：逐阶段实施步骤、修复可能引入的二次风险、测试门槛、发布与回滚清单。
